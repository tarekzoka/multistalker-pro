...
wget -O /tmp/multistalker-pro-1.2.tar.gz "https://raw.githubusercontent.com/tarekzoka/multistalker-pro/main/multistalker-pro-1.2.tar.gz"

tar -xzf /tmp/multistalker-pro-1.2.tar.gz -C /
